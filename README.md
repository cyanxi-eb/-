...
- **双形态**：单文件 `面试背记学习卡v2.9.html`（双击即用）+ `dist/`（PWA 分片可部署）
...
直接双击打开 `dist/面试背记学习卡v2.9.html` 即可，无需联网、无需服务器。数据已内联，`file://` 协议下功能完整可用。
...
产出：
- `dist/面试背记学习卡v2.9.html` —— 单文件版（数据内联）
