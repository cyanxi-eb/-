...
(function (global) {
  ...
  const SUPABASE_URL = 'https://imbzbrtgexcpofllelok.supabase.co/rest/v1/';        // 例如 'https://abcdefghijkl.supabase.co'
  const SUPABASE_ANON_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImltYnpicnRnZXhjcG9mbGxlbG9rIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODg2OTE1ODgsImV4cCI6MjEwNDI2NzU4OH0.SXadb7QX287584mCvJHjGCb9X8433kfY6SBGop-cJiY';   // 例如 'eyJhbGciOiJIUzI1NiIsInR5cCI6...'（anon public key）
